...
export const SET_INITAL_MONEY = 'SET_INITAL_MONEY'
export const SET_TEMPEST_CONFIG   = 'SET_TEMPEST_CONFIG'
export const TEMPEST_CONFIG_BEGIN = 'TEMPEST_CONFIG_BEGIN'
export const TEMPEST_CONFIG_ERROR = 'TEMPEST_CONFIG_ERROR'
export const RESET_TEMPEST_STATE  = 'RESET_TEMPEST_STATE'